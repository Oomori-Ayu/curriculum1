...
public final class ConstSQL {
    ...
    public static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/lesson2_db";
    ///public static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/Employee";
    /** ユーザー名 */
    ...
    /** ・SQL SELECT文 */
    //public static final String SQL_SELECT = "SELECT * FROM Employee WHERE EmpId = ? AND Password = ?";
    public static final String SQL_SELECT = "SELECT * FROM Employee WHERE empId = ?";


    /** ・SQL UPDATE文 */
    public static final String SQL_UPDATE = "UPDATE Employee SET login_time= ?  WHERE empId = ?";

    /** ・SQL INSERT文 */
    public static final String SQL_INSERT = "INSERT INTO Employee(EmpId,Password,Name,Mail,ProgramingLanguage,Comment) "
    		                                    + "VALUES (?,?,?,?,?,?)  WHERE empId = ?";
