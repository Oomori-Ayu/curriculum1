...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
        	...
        	EmployeeBean kkEmployeeBean = new EmployeeBean();
        	kkEmployeeBean.setEmpId(reqEmpId);
        	kkEmployeeBean.setPassword(reqPassword);

        	responseBean = this.ems.getEmployeeData(ExecuteCase.FIND_BY_EMPID,kkEmployeeBean);
            ...
            if (Objects.nonNull(resEmployeeBean)) {
                ...
                Logger.log(new Throwable(), "hashPassword = " + hashPassword);
                Logger.log(new Throwable(), "resEmployeeBean.getPassword = "+ resEmployeeBean.getPassword());
