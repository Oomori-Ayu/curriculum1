...
public final class EmployeeManagementController extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Tips: 定義済みフィールド変数を使用
        // [ここへ記述]
        EmployeeManagementService sev = new EmployeeManagementService();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // [ここへ記述]
            EmployeeManagementService sev = new EmployeeManagementService();
            ResponseBean bean = sev.executeDBAccess(null, null);
            request.setAttribute("CONST_REQUST_KEY_FOR_RESPONSE_BEAN", bean);
